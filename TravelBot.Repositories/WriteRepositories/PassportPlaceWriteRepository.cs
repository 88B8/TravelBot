...
public class PassportPlaceWriteRepository : BaseWriteRepository<PassportPlace>, IPassportPlaceWriteRepository,
    IRepositoryAnchor
{
    /// <summary>
    ///     ctor
    /// </summary>
    public PassportPlaceWriteRepository(IWriter writer, IDateTimeProvider dateTimeProvider) : base(writer,
        dateTimeProvider)
    {
    }
}