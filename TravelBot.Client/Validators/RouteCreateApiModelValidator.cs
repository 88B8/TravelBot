...
{
    /// <summary>
    /// Валидатор <see cref="RouteCreateApiModel"/>
    /// </summary>
    public class RouteCreateApiModelValidator : AbstractValidator<RouteCreateApiModel>
    {
        /// <summary>
        /// ctor
        /// </summary>
        public RouteCreateApiModelValidator()
        {
            RuleFor(x => x.Budget)
                .NotEmpty()
            ...
            RuleFor(x => x.ReasonToVisit)
                ...
                .WithMessage($"Длина причины для посещения должна быть от {RouteValidationRules.MinReasonToVisitLength} до {RouteValidationRules.MaxReasonToVisitLength} символов");
            ...
            RuleFor(x => x.StartPoint)
                ...
                .WithMessage($"Длина отправной точки должна быть от {RouteValidationRules.MinStartPointLength} до {RouteValidationRules.MaxStartPointLength} символов");
        }
