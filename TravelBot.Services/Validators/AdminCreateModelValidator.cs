...
public class AdminCreateModelValidator : AbstractValidator<AdminCreateModel>
{
    public AdminCreateModelValidator()
    {
        RuleFor(x => x.Name)
            ...
            .WithMessage(
                $"Длина имени должна быть от {AdminValidationRules.MinNameLength} до {AdminValidationRules.MaxNameLength} символов");
        ...
        RuleFor(x => x.Login)
            ...
            .WithMessage(
                $"Длина логина должна быть от {AdminValidationRules.MinLoginLength} до {AdminValidationRules.MaxLoginLength} символов");
        ...
        RuleFor(x => x.Password)
            ...
            .Length(AdminValidationRules.MinNameLength, AdminValidationRules.MaxNameLength)
            .WithMessage(
                $"Длина пароля должна быть от {AdminValidationRules.MinNameLength} до {AdminValidationRules.MaxNameLength} символов");
    }
}