...
public class PassportService : IPassportService, IServiceAnchor
{
    ...
    ///     ctor
    /// </summary>
    public PassportService(IPassportReadRepository passportReadRepository,
        IPassportWriteRepository passportWriteRepository, IPlaceReadRepository placeReadRepository,
        IPassportPlaceReadRepository passportPlaceReadRepository,
    ...
    async Task<PassportModel> IPassportService.Edit(Guid id, PassportCreateModel model,
        CancellationToken cancellationToken)
    {
        ...
        var placesToDelete = passportPlaces
            .Where(x => placeToDeleteIds.Contains(x.PlaceId))
            .ToList();
