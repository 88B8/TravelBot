...
public class RouteService : IRouteService, IServiceAnchor
{
    ...
    ///     ctor
    /// </summary>
    public RouteService(IRouteReadRepository routeReadRepository, IRouteWriteRepository routeWriteRepository,
        IPlaceReadRepository placeReadRepository, IRoutePlaceReadRepository routePlaceReadRepository,
        IRoutePlaceWriteRepository routePlaceWriteRepository, IUnitOfWork unitOfWork, IMapper mapper)
    {
    ...
    async Task<RouteModel> IRouteService.Edit(Guid id, RouteCreateModel model, CancellationToken cancellationToken)
    {
        ...
        foreach (var placeToDelete in placesToDelete) routePlaceWriteRepository.Delete(placeToDelete);
