...
public class CategoryService : ICategoryService, IServiceAnchor
{
    ...
    public CategoryService(ICategoryReadRepository categoryReadRepository,
        ICategoryWriteRepository categoryWriteRepository, IUnitOfWork unitOfWork, IMapper mapper)
    {
    ...
    async Task<CategoryModel> ICategoryService.Edit(Guid id, CategoryCreateModel model,
