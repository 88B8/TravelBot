...
namespace TravelBot.Context
{
    ...
    public class TravelBotDbContextDesignTimeFactory : IDesignTimeDbContextFactory<TravelBotContext>
    {
        ...
        /// dotnet ef database update --project TravelBot.Context\TravelBot.Context.csproj --connection "Host=localhost;Port=5432;Database=TravelBot;Username=postgres;Password=123"
        /// </remarks>
